  ...
  <nav class="sidebar">
    <div class="navbar-collapse" id="navbar-collapse">
      <div class="site-header hidden-xs">
        ...
        <p>Welcome to the Great Lakes Biomimicry Mix & Match Game</p>
      </div>
      <ul class="nav">
...
<div class="hero-full-wrapper">
  ...
  <div class="gutter-sizer"></div>
    ...
    <div class="grid-item">
      <img class="img-responsive" alt="King Fisher Bird" src="./img/KingFisher_Front.jpg">
      <a href="playGame" class="project-description">
      <!--<c:url var="questionNumber" value="${question.questionNumber}"/><img src="${questionNumber}">-->
        <div class="project-text-holder">
          <div class="project-text-inner">
            <h3>King Fisher Bird</h3>
            <p>Discover more</p>
          </div>
        </div>
      </a>
