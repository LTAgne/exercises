...
19. You are driving a little too fast, and a police officer stops you. Write code to compute the result, 
	 ...
	 caughtSpeeding(65, false) → 1     ** driving boolean is redundant
	 caughtSpeeding(65, true) → 0
	 */
	public int caughtSpeeding(int speed, boolean isBirthday) {
		boolean birthdayDriving = isBirthday;
...
/*
	...
	public boolean nearTen(int num) {
		return (((num-1)%10==0) || ((num+1)%10==0) || ((num-2)%10==0) || ((num+2)%10==0) || (num%10==0));
	}
	...
	public boolean answerCell(boolean isMorning, boolean isMom, boolean isAsleep) {
		return ((!isAsleep && isMorning && isMom) || (!isMorning & !isAsleep));
	}
...
/*
	...
	public int teaParty(int tea, int candy) {
		...
		/*	below worked but I don't know why
...
/*
	 34. Given 3 int values, a b c, return their sum. However, if one of the values is the same as another of the values, it does not count towards the sum.
	 loneSum(1, 2, 3) → 6
	 loneSum(3, 2, 3) → 2
	 loneSum(3, 3, 3) → 0
	 */
		public int loneSum(int a, int b, int c) {
			boolean aAndBSame = (a==b);
			boolean bAndCSame = (b==c);
			boolean aAndCSame = (a==c);
			boolean allSame = (aAndBSame && aAndCSame);
	...
	public int luckySum(int a, int b, int c) {
		boolean valueAIs13 = (a==13);
		boolean valueBIs13 = (b==13);
		boolean valueCIs13 = (c==13);
				if ((valueAIs13) && (valueBIs13)){
					return 0;
				}else if (valueAIs13) {
					return (c);
				}else if (valueBIs13) {
